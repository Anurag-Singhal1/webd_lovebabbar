...
const get = (param) => document.getElementById(`${param}`);               // get is function here 
...
// const prefersDarkMode = window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches;
  ...
  const value = localStorage.getItem("dark-mode");       // it is key, by this we get our value from local storage
  ...
  //by default, anurag ki info show krre h UI pr
  getUserData(url + "Anurag-Singhal1");
}
